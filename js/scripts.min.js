...
window.onload = function() {
    ...
    message.style.opacity = 0.5; // اجعل النص ظاهرًا عند تحميل الصفحة
};
...
// تحديد تاريخ الإفطار (10 مارس 2024 الساعة 5:30 مساءً)
const ramadan10 = new Date("2026-03-10T17:30:00").getTime();
